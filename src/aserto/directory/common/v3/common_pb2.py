...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_OBJECTDEPENDENCY'].fields_by_name['object_type']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['object_id']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['object_id']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['relation']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['relation']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_type']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_type']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_id']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_id']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_relation']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['subject_relation']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['depth']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['depth']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['is_cycle']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['is_cycle']._serialized_options = b'\340A\003'
  _globals['_OBJECTDEPENDENCY'].fields_by_name['path']._options = None
  _globals['_OBJECTDEPENDENCY'].fields_by_name['path']._serialized_options = b'\340A\003'
  ...
  _globals['_OBJECTDEPENDENCY']._serialized_start=2412
  _globals['_OBJECTDEPENDENCY']._serialized_end=2743
  _globals['_OBJECTIDENTIFIER']._serialized_start=2746
  _globals['_OBJECTIDENTIFIER']._serialized_end=3207
  _globals['_RELATIONIDENTIFIER']._serialized_start=3210
  _globals['_RELATIONIDENTIFIER']._serialized_end=4701
  _globals['_PAGINATIONREQUEST']._serialized_start=4703
  _globals['_PAGINATIONREQUEST']._serialized_end=4783
  _globals['_PAGINATIONRESPONSE']._serialized_start=4785
  _globals['_PAGINATIONRESPONSE']._serialized_end=4841
