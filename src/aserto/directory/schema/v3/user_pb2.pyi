...
class UserProperties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_id", b"connection_id", "email", b"email", "enabled", b"enabled", "picture", b"picture", "status", b"status"]) -> None: ...
