...
class DeleteObjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["object_id", b"object_id", "object_type", b"object_type", "with_relations", b"with_relations"]) -> None: ...
...
class DeleteRelationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["object_id", b"object_id", "object_type", b"object_type", "relation", b"relation", "subject_id", b"subject_id", "subject_relation", b"subject_relation", "subject_type", b"subject_type"]) -> None: ...
