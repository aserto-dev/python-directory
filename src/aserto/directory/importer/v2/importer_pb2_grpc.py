...
from aserto.directory.importer.v2 import importer_pb2 as aserto_dot_directory_dot_importer_dot_v2_dot_importer__pb2
...
def add_ImporterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Import': grpc.stream_stream_rpc_method_handler(
                    servicer.Import,
                    request_deserializer=aserto_dot_directory_dot_importer_dot_v2_dot_importer__pb2.ImportRequest.FromString,
                    response_serializer=aserto_dot_directory_dot_importer_dot_v2_dot_importer__pb2.ImportResponse.SerializeToString,
            ),
    }
